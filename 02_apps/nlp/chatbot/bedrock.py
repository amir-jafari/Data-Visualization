...
# %% ----- Configuration
# One shared .env for every chatbot demo, kept next to this file in `chatbot/`.
...
print(f"[bedrock] loaded .env from: {ENV_PATH if ENV_PATH.is_file() else f'{ENV_PATH} NOT FOUND'}")
print(f"[bedrock] using MODEL_ID: {MODEL_ID}")
