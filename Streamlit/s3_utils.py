"""
Shared S3 access for every Streamlit app in this folder.
...
# Where to look for a .env, in order. The repo's S3/.env is the shared one.
_HERE = Path(__file__).resolve().parent
ENV_CANDIDATES = (_HERE / ".env", _HERE.parent / "S3" / ".env")
